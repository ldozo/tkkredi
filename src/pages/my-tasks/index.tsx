...
const MyTasks: React.FC = () => {
  ...
  // Örnek veri - Burada API'den kullanıcıya atanan görevler gelecek
  const tasks: Task[] = [
    {
      id: "1",
      taskId: "TASK-001",
      ...
      status: "BEKLEMEDE",
      assignee: "ahmet.yilmaz@tkkredi.com", // Giriş yapan kullanıcının e-postası
      department: "Kredi",
      dueDate: "15.03.2024",
    },
    {
